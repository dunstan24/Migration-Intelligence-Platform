...
def get_skill_boost(points, english, experience):
    ...
    # Target-Based Experience Experience weight
    if experience >= 10: boost += 0.25
    elif experience >= 7: boost += 0.20
    elif experience >= 5: boost += 0.18
    elif experience >= 4: boost += 0.16
    elif experience >= 3: boost += 0.15
    elif experience >= 2: boost += 0.10
    elif experience >= 1: boost += 0.00
    elif experience == 0: boost -= 0.12
...
cases = [
    ...
    (65, "proficient", 7, "7yr Mid Target"),
    (75, "proficient", 7, "7yr Elite Target (~90.0%)"),
    (65, "superior", 7, "7yr Superior Target (~90.0%)"),
]
